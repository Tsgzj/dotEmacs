...
(defun color-theme-molokai ()
  ...
  (color-theme-install
   '(color-theme-molokai
     ...
     (default ((t (:foreground "#F8F8F2" :background "#262626"))))
     (bold ((t (:weight bold))))
     (bold-italic ((t (:weight bold :slant italic))))
     (custom-face-tag ((t (:foreground "#66D9EF" :weight bold))))
     (custom-state ((t (:foreground "#A6E22E"))))
     (italic ((t (:slant italic))))
     (region ((t (:foreground "#000000" :background "#FED505"))))
     (underline ((t (:underline t))))
     (css-selector ((t (:foreground "#F9408C"))))
     ...
     (mode-line-buffer-id ((t (:foreground nil :background "#D0D0D0" :weight semi-bold))))
     (mode-line-inactive ((t (:foreground "#060606" :background "#A0A0A0"
                                          :box (:line-width 1 :color "#232526")))))
     (mode-line-mousable ((t (:foreground "#BCBCBC" :background "#D0D0D0"))))
     (mode-line-mousable-minor-mode ((t (:foreground "#BCBCBC" :background "#D0D0D0"))))
     ...
     (font-lock-function-name-face ((t (:foreground "#F9408C" :slant italic))))
     ...
     (font-lock-variable-name-face ((t (:foreground "#F9408C"))))
     (font-lock-warning-face ((t (:foreground "#FFFFFF"
                                              :background "#333333"))))
     (fringe ((t (:background "#232526"))))
     (highlight ((t (:foreground "#000000" :background "#C4D289"))))
     (hl-line ((t (:background "#293739"))))
     (icompletep-choices ((t (:foreground "#F9408C"))))
     (icompletep-determined ((t (:foreground "#A6E22E"))))
     (icompletep-keys ((t (:foreground "#F9408C"))))
     ...
     (markdown-header-face-2 ((t (:foreground "#F9408C"))))
     ...
     (markdown-link-title-face ((t (:foreground "#F9408C"))))
     ...
     (woman-bold ((t (:foreground "#F9408C"))))
